<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="viewcancelorderdetail.aspx.cs" Inherits="WebApplication1.viewcancelorderdetail" %>
    ...
    <div id="cancelorderdetail">
          <div>
           <asp:Button ID="Button1" runat="server" Text="< Back" Font-Bold="true" CssClass="backordermenu" OnClick="Button1_Click" />
               <asp:Button ID="Button2" runat="server" Text="Generate PDF" Font-Bold="true" CssClass="backordermenu" OnClick="Button2_Click" />
      </div>
       <div style="text-align:center;">
         <h3 style="text-align:center; font-weight:bold"> Customer canceled Order Detail </h3>
      </div>


           <%-- store customer and salespsersion info  --%>
      <div id="cancelorderdetail1" style="float:left; width:100%;  border:solid 1px; padding:1%; margin-bottom: 5%; margin-left:2%;">
      ...
      <div id="createorder2" style="width:100%;   margin-bottom: 10%;  margin-left:2%;">
       ...
       <div id="createorder3" style="width:100%;   margin-bottom: 10%;  margin-left:2%;">
        <div class="col-xs-12"  style="width:100%;   border:solid 1px;  margin-bottom:10%;">
